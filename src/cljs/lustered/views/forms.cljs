...
(defmethod render-field :default [field value rendered errors _]
  [FormControlsStatic
   {:label (:label field)
...
(defmethod render-field :text [field value _ errors updater]
  (let [{field-name :field field-label :label} field]
    [Input {:type :text
            :label field-label
            :label-class-name "col-xs-3"
            :wrapper-class-name "col-xs-9"
            :help (when errors (apply str errors))
            :bs-style (when errors :error)
            :placeholder field-label
            :default-value value
            :on-change (fn [e] (updater (.. e -target -value)))}]))

(defmethod render-field :password [field value _ errors updater]
  (let [{field-name :field field-label :label} field]
    [Input {:type :password
            :label field-label
            :label-class-name "col-xs-3"
...
(defmethod render-field :select [field value _ errors updater]
  (let [{field-name :field field-label :label} field
        values (:values field)
...
(defmethod render-field :radio [field value _ errors updater]
  (let [{field-name :field field-label :label} field
        values (:values field)
...
(defmethod render-field :checkbox [field value _ errors updater]
  (let [{field-name :field field-label :label} field
        value (boolean value)
...
(defmethod render-field :multi-select [field value _ errors updater]
  (let [{:field-name :field field-label :label} field
        value (or value [])]
    (updater value)
    [Input {:type :select
...
(defmethod render-field :multi-checkbox [field value _ errors updater]
  (let [{field-name :field field-label :label} field
        value (or value #{})]
    (updater value)
    [:div.form-group
